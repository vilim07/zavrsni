...
import { removeAlbum, toggleTrade } from "../../firebase/firebaseFunctions";
        ...
        >
            {!marketPage ? (
                <>
                    ...
                    <li>
                        <a onClick={() => removeAlbum(id)} className="text-error font-medium hover:text-neutral hover:bg-error ease-in duration-200">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                ...
                <>
                    <li>
                        <a onClick={() => contactOwner(owner, router)}>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
